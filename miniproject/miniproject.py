...
def Selectionsort():
    ...
    def update_display(arr, i, min_index):
        ...
        canvas.create_text(180, 20, text="สลับ:")
        ...
        for idx, val in enumerate(arr):
            ...
            canvas.create_text(180, 50 + idx * 20, text="สลับ" if idx == i else "", anchor="w", fill=color)
    ...
    # ปุ่ม "ยกเลิก"
    button2 = Button(Selection,text="ยกเลิก", font=5, command=exitmenu)
